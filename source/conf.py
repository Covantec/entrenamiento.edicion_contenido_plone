# -*- coding: utf-8 -*-
#
# Manual de usuario de Plone 4 documentation build configuration file, created by
...
project = u'Manual de usuario de Plone 4'
...
htmlhelp_basename = 'ManualUsuarioPlone4doc'
...
latex_documents = [
  ('index', 'ManualUsuarioPlone4.tex',
  u'Manual de usuario de Plone 4', _stdauthor, 'manual'),
]
...
latex_appendices = ['glosario','acerca','copyright','licencia']
...
#man_pages = [
#    ('index', 'manualusuarioplone4', u'Manual de usuario de Plone 4',
...
texinfo_documents = [
  ('index', 'ManualUsuarioPlone4', u'Manual de usuario de Plone 4',
   u'Leonardo J. Caballero G.', 'ManualUsuarioPlone4', 'One line description of project.',
   'Miscellaneous'),
]
...
epub_title = u'Manual de usuario de Plone 4'
...
#epub_basename = u'Manual de usuario de Plone 4'
